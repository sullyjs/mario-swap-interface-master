...
import { Button, Text } from '@marioswap-libs/uikit'
            ...
            <>
              ...
              <Text color="failure">
                {transactionType === 'Buying'
                  ? 'You will not receive SHROOM rewards for holding purchased SYRUP.'
                  : 'You will need to buy back the same amount of SYRUP to be able to convert back to SHROOM.'}
              </Text>
            </>
          )}
          <RowBetween>
