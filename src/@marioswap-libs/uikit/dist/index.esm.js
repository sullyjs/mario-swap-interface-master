...
var styleVariants$1 = (_b = {},
    _b[variants$2.PRIMARY] = {
        backgroundColor: "primary",
        color: "white",
    },
    _b[variants$2.SECONDARY] = {
    ...
    _b[variants$2.TERTIARY] = {
        backgroundColor: "tertiary",
        boxShadow: "none",
        color: "primary",
    },
    _b[variants$2.SUBTLE] = {
        backgroundColor: "textSubtle",
        color: "white",
    },
    _b[variants$2.DANGER] = {
        backgroundColor: "failure",
        color: "white",
    },
    _b[variants$2.SUCCESS] = {
...
var StyledButton = styled.button(templateObject_1$L || (templateObject_1$L = __makeTemplateObject(["\n  align-items: center;\n  border: 0;\n  border-radius: 16px;\n  box-shadow: 0px -1px 0px 0px rgba(14, 14, 44, 0.4) inset;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s;\n\n  &:hover:not(:disabled):not(.mario-button--disabled):not(.mario-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n\n  &:active:not(:disabled):not(.mario-button--disabled):not(.mario-button--disabled) {\n    opacity: 0.85;\n  }\n\n  ", "\n  ", "\n  ", "\n  ", "\n  ", "\n"], ["\n  align-items: center;\n  border: 0;\n  border-radius: 16px;\n  box-shadow: 0px -1px 0px 0px rgba(14, 14, 44, 0.4) inset;\n  cursor: pointer;\n  display: inline-flex;\n  font-family: inherit;\n  font-size: 16px;\n  font-weight: 600;\n  justify-content: center;\n  letter-spacing: 0.03em;\n  line-height: 1;\n  opacity: ", ";\n  outline: 0;\n  transition: background-color 0.2s;\n\n  &:hover:not(:disabled):not(.mario-button--disabled):not(.mario-button--disabled):not(:active) {\n    opacity: 0.65;\n  }\n\n  &:active:not(:disabled):not(.mario-button--disabled):not(.mario-button--disabled) {\n    opacity: 0.85;\n  }\n\n  ", "\n  ",
    "\n  ",
...
var Button = function (props) {
    ...
    if (isLoading) {
        classNames.push("mario-button--loading");
    }
    if (isDisabled && !isLoading) {
        classNames.push("mario-button--disabled");
    }
...
var Icon$H = function (props) {
    return (React.createElement("img", __assign({ src: "/images/logo32x32.png", alt: "Logo" }, props)));
};

var Icon$G = function (props) {
    return (React.createElement("img", __assign({ src: "/images/logo-round512x512.png", alt: "LogoRound" }, props))
...
var Icon$C = function (props) {
    return (React.createElement("img", __assign({ src: "/images/mario64x64.png", alt: "Mario" }, props))
...
var Icon$B = function (props) {
    return (React.createElement("img", __assign({ src: "/images/mario-round90x90.png", alt: "MarioRound" }, props))
...
var ButtonMenu = function (_a) {
    var _b = _a.activeIndex, activeIndex = _b === void 0 ? 0 : _b, _c = _a.scale, scale = _c === void 0 ? scales$4.MD : _c, _d = _a.variant, variant = _d === void 0 ? variants$2.PRIMARY : _d, onItemClick = _a.onItemClick, children = _a.children;
...
var ButtonMenuItem = function (_a) {
    var _b = _a.isActive, isActive = _b === void 0 ? false : _b, _c = _a.variant, variant = _c === void 0 ? variants$2.PRIMARY : _c, as = _a.as, props = __rest(_a, ["isActive", "variant", "as"]);
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ forwardedAs: as, variant: "tertiary", colorKey: variant === variants$2.PRIMARY ? "primary" : "textSubtle" }, props)));
    }
...
var toadFall = keyframes(templateObject_1$w || (templateObject_1$w = __makeTemplateObject(["\n  0% {\n    opacity: 1;\n    transform: translate(0, -100%) rotateZ(0deg);\n  }\n\n  75% {\n    opacity: 1;\n    transform: translate(100px, 75vh) rotateZ(270deg);\n  }\n\n  100% {\n    opacity: 0;\n    transform: translate(150px, 100vh) rotateZ(360deg);\n  }\n"], ["\n  0% {\n    opacity: 1;\n    transform: translate(0, -100%) rotateZ(0deg);\n  }\n\n  75% {\n    opacity: 1;\n    transform: translate(100px, 75vh) rotateZ(270deg);\n  }\n\n  100% {\n    opacity: 0;\n    transform: translate(150px, 100vh) rotateZ(360deg);\n  }\n"])));
var Toad = styled.div(templateObject_2$c || (templateObject_2$c = __makeTemplateObject(["\n  display: inline-flex;\n  position: fixed;\n  top: 0;\n  left: ", ";\n  transform: translate3d(0, -100%, 0);\n  user-select: none;\n  pointer-events: none;\n  z-index: 99999;\n\n  animation-name: ", ";\n  animation-duration: ", ";\n  animation-timing-function: linear;\n  animation-iteration-count: ", ";\n  animation-play-state: running;\n\n  &:nth-child(5n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 2) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(2n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 10) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(7n + 2) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(4n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 7) {\n    animation-delay: ", ";\n  }\n"], ["\n  display: inline-flex;\n  position: fixed;\n  top: 0;\n  left: ", ";\n  transform: translate3d(0, -100%, 0);\n  user-select: none;\n  pointer-events: none;\n  z-index: 99999;\n\n  animation-name: ", ";\n  animation-duration: ", ";\n  animation-timing-function: linear;\n  animation-iteration-count: ", ";\n  animation-play-state: running;\n\n  &:nth-child(5n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 2) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(2n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 10) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(7n + 2) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(4n + 5) {\n    animation-delay: ", ";\n  }\n\n  &:nth-child(3n + 7) {\n    animation-delay: ", ";\n  }\n"])), function (_a) {
    var position = _a.position;
    return position + "vw";
}, toadFall, function (_a) {
...
var FallingToads = function (_a) {
    var _b = _a.count, count = _b === void 0 ? 30 : _b, _c = _a.size, size = _c === void 0 ? 32 : _c, _d = _a.iterations, iterations = _d === void 0 ? Infinity : _d, _e = _a.duration, duration = _e === void 0 ? 10 : _e;
    var toads = __spreadArray([], Array(count)).map(function (_, index) { return (React.createElement(Toad, { key: String(index), position: Math.random() * 100, iterations: iterations, duration: duration },
        React.createElement(Icon$H, { width: size, height: size }))); });
    return React.createElement("div", null, toads);
};
...
var ProgressToadWrapper = styled.div(templateObject_1$l || (templateObject_1$l = __makeTemplateObject(["\n  display: flex;\n  z-index: 2;\n  top: -65%;\n  position: absolute;\n  transform: translate(-50%, -50%);\n  transition: left 200ms ease-out;\n"], ["\n  display: flex;\n  z-index: 2;\n  top: -65%;\n  position: absolute;\n  transform: translate(-50%, -50%);\n  transition: left 200ms ease-out;\n"])));
var templateObject_1$l;
...
var Progress = function (_a) {
    var _b = _a.variant, variant = _b === void 0 ? variants.ROUND : _b, _c = _a.primaryStep, primaryStep = _c === void 0 ? 0 : _c, _d = _a.secondaryStep, secondaryStep = _d === void 0 ? null : _d, _e = _a.showProgressToad, showProgressToad = _e === void 0 ? false : _e;
    return (React.createElement(StyledProgress, { variant: variant },
        showProgressToad && (React.createElement(ProgressToadWrapper, { style: { left: stepGuard(primaryStep) + "%" } },
...
var Icon$o = function (props) {
    return (React.createElement("img", __assign({ src: "/images/mario-running.gif", alt: "Loading.." }, props))
...
var RotatingMarioIcon = styled(Icon$o)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;  \nanimation: ", " 2s linear infinite;\ntransform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;  \nanimation: ", " 2s linear infinite;\ntransform: translate3d(0, 0, 0);\n"])), rotate);
styled(Icon$p)(templateObject_5$2 || (templateObject_5$2 = __makeTemplateObject(["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  animation: ", " 6s ease-in-out infinite;\n  transform: translate3d(0, 0, 0);\n"])), float);
var Spinner = function (_a) {
    var _b = _a.size, size = _b === void 0 ? 128 : _b;
    return (React.createElement(Container$3, null,
        React.createElement(RotatingMarioIcon, { width: size * 0.5 + "px" })));
};
...
var Logo$2 = function (_a) {
    ...
    return (React.createElement("img", __assign({ src: "/images/nav-logo.png", alt: "NavLogo" }, props))
...
var Logo = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "Mario home page" }, innerLogo)) : (React.createElement(StyledLink, { to: href, "aria-label": "Mario home page" }, innerLogo))));
};
...
var links = [
    ...
    },
    {
        ...
        items: [
            {
                label: "Exchange",
                href: "https://exchange.marioswap.finance",
            },
            {
                label: "Liquidity",
                href: "https://exchange.marioswap.finance/#/pool",
            },
        ],
    },
    {
...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/marioswap",
            },
            {
                label: "Bahasa Indonesia",
                href: "https://t.me/MarioSwapIndonesia",
            },
            {
                label: "中文",
                href: "https://t.me/MarioSwap_CN",
            },
            {
                label: "Tiếng Việt",
                href: "https://t.me/MarioSwapVN",
            },
            {
                label: "Italiano",
                href: "https://t.me/marioswap_ita",
            },
            {
                label: "русский",
                href: "https://t.me/marioswap_ru",
            },
            {
                label: "Türkiye",
                href: "https://t.me/marioswapturkiye",
            },
            {
                label: "Português",
                href: "https://t.me/MarioSwapPortuguese",
            },
            {
                label: "Español",
                href: "https://t.me/MarioswapEs",
            },
            {
                label: "日本語",
                href: "https://t.me/marioswapjp",
            },
            {
                label: "Français",
                href: "https://t.me/marioswapfr",
            },
            {
                label: "Announcements",
                href: "https://t.me/MarioSwapAnn",
            },
            {
                label: "Whale Alert",
                href: "https://t.me/MarioSwapWhales",
            },
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/marioswap",
    },
];
var MENU_HEIGHT = 64;
...
var ShroomPrice = function (_a) {
    var shroomPriceUsd = _a.shroomPriceUsd;
    return shroomPriceUsd ? (React.createElement(PriceLink, { href: "https://marioswap.info/token/0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank" },
        React.createElement(Icon$B, { width: "24px", mr: "8px" }),
        React.createElement(Text, { color: "textSubtle", bold: true }, "$" + shroomPriceUsd.toFixed(3)))) : (React.createElement(Skeleton, { width: 80, height: 24 }));
};
var ShroomPrice$1 = React.memo(ShroomPrice);
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav, toggleTheme = _a.toggleTheme, isDark = _a.isDark, shroomPriceUsd = _a.shroomPriceUsd, currentLang = _a.currentLang, langs = _a.langs, setLang = _a.setLang;
    if (!isPushed) {
    ...
    return (React.createElement(Container, null,
        React.createElement(SocialEntry, null,
            React.createElement(ShroomPrice$1, { shroomPriceUsd: shroomPriceUsd }),
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss },
        ...
        React.createElement(HelpLink, { href: "https://docs.marioswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true },
...
var Avatar = function (_a) {
    ...
    var _b = profile.username, username = _b === void 0 ? "Toad" : _b, image = profile.image, profileLink = profile.profileLink, noProfileLink = profile.noProfileLink, _c = profile.showPip, showPip = _c === void 0 ? false : _c;
...
var StyledNav = styled.nav(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    ...
    var theme = _a.theme;
    return theme.nav.menuBackground;
});
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, shroomPriceUsd = _a.shroomPriceUsd, links = _a.links, profile = _a.profile, children = _a.children;
    ...
    return (React.createElement(Wrapper, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, shroomPriceUsd: shroomPriceUsd, pushNav: setIsPushed, links: links }),
...
var light$2 = {
    menuBackground: lightColors.card,
    background: lightColors.card,
    hover: "#EEEAF4",
};
var dark$2 = {
    menuBackground: darkColors.card,
    background: darkColors.card,
    hover: "#473d5d",
};
...
export { Icon$11 as AddIcon, Alert, Icon$10 as ArrowBackIcon, Icon$$ as ArrowDownIcon, Icon$_ as ArrowDropDownIcon, Icon$Z as ArrowDropUpIcon, Icon$Y as ArrowForwardIcon, Icon$X as AutoRenewIcon, BackgroundImage, GridLayout$1 as BaseLayout, Icon$W as BinanceIcon, Icon$13 as BlockIcon, Box, Breadcrumbs, Button, ButtonMenu, ButtonMenuItem, Icon$T as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$U as CardViewIcon, GridLayout as CardsLayout, Checkbox, Icon$15 as CheckmarkCircleIcon, Icon$S as CheckmarkIcon, Icon$R as ChevronDownIcon, Icon$Q as ChevronLeftIcon, Icon$P as ChevronRightIcon, Icon$O as ChevronUpIcon, Icon$N as CloseIcon, Icon$M as CogIcon, Icon$L as CommunityIcon, ConnectorNames, Icon$K as CopyIcon, Dropdown, Icon$14 as ErrorIcon, FallingToads, Flex, Heading, Icon$J as HelpIcon, IconButton, Image, Icon$12 as InfoIcon, Input$1 as Input, Link, LinkExternal, Icon$I as ListViewIcon, Icon$H as LogoIcon, Icon$G as LogoRoundIcon, Icon$B as MarioRoundIcon, Icon$C as MariosIcon, Menu, Icon$F as MinusIcon, Modal, ModalProvider, Icon$E as NoProfileAvatarIcon, Icon$D as OpenNewIcon, Icon$A as PrizeIcon, Progress, Icon$x as ProgressToad, Radio, Icon$z as RemoveIcon, ResetCSS, Icon$t as SearchIcon, Skeleton, Spinner, Svg, Icon$s as SwapVertIcon, Icon$r as SyncAltIcon, Tag, Text, Icon$v as Ticket, Icon$u as TicketRound, Icon$V as ToadPlaceholderIcon, ToastContainer, Toggle, Icon$y as VerifiedIcon, Icon$q as WarningIcon, Icon$w as Won, variants$1 as alertVariants, byTextAscending, byTextDescending, connectorLocalStorageKey, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useKonamiCheatCode, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
